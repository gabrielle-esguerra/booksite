...
-- Date: Thu, 14 Sep 2023 00:56:06 +0000
...
SET autocommit=0;
INSERT INTO `Books` VALUES (1,1,1,'Little Women',1868,'littlewomen.jpg'),(2,2,2,'IT',10000,'it.jpg'),(3,3,3,'Twilight',2008,'twilight.jpg'),(4,4,4,'1984',1949,'1984.jpg'),(5,5,5,'Normal People',2018,'normalpeople.jpg'),(6,5,5,'Conversations with Friends',2017,'conversationswfriends.jpg'),(7,2,2,'Misery',1987,'misery.jpg'),(8,6,6,'Gone Girl',2012,'gonegirl.jpg'),(9,4,4,'Animal Farm',1945,'animalfarm.jpg'),(10,4,4,'Animal Farm',1945,'animalfarm.jpg');
/*!40000 ALTER TABLE `Books` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `Books` with 10 row(s)
--
...
CREATE TABLE `Favourites` (
  ...
  CONSTRAINT `Favourites_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `Users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
...
SET autocommit=0;
INSERT INTO `Users` VALUES (1,'Gabrielle','$2y$10$EYZMXafM3OtLbDhxJingFuzmO39dMl4G/0G2rPV6l2sOySAjapnMW'),(2,'Arlene','/$%!'),(3,'admin','$2y$10$JeCOrD0w0PshqGwu/J/AiOtMmDullb6XA15hGt181zojeLYKs5sM2'),(4,'TestUser','$2y$10$BGnEOXFLqH47JfDKfRGZjOsnIlRQuauH87sWFZcebvBbihpDfV8na'),(5,'testingforthirtychractersinput','$2y$10$GyWzaDYUwzx/O4JU3KknJeyKP3uUie2.Hxz6dAee1tn6B0X72tj7O');
...
-- Dump completed on: Thu, 14 Sep 2023 00:56:06 +0000
